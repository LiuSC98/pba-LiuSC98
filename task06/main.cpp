...
void WdWddW_Spring3(
  ...
  const Eigen::Matrix3d n = stiffness * u01 * u01.transpose() + stiffness * C / length * (I - u01 * u01.transpose());
  // also, simplfy the above formula, we have:
  // const Eigen::Matrix3d n = stiffness * (I + length_ini / length * (u01 * u01.transpose() - I));
